...
Fujifilm X-series film-simulation recipes over USB-C OTG (PTP). Protocol details live in
`PROTOCOL.md` (a living document — keep it accurate as implementation reveals new details).
